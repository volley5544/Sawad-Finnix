...
class NativeCameraBridge {
  ...
  static JSObject? get _host {
    final value = (web.window as JSObject)
        .getProperty<JSAny?>('flutter_inappwebview'.toJS);
  ...
  /// `idcard`, `selfie`, `document`) and resolves with the captured image bytes.
  ///
  ...
  static Future<Uint8List?> captureDocument(String action) async {
    ...
    final base64 =
        result.isUndefinedOrNull ? null : (result as JSString).toDart;
