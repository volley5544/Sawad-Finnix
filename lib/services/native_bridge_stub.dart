...
/// Non-web stub. The finnix web build is meant to run inside the native
/// WebView host; on the VM / mobile / desktop there is no host to talk to, so
/// the camera bridge is unavailable. The same finnix codebase compiles for all
/// targets thanks to the conditional export in `native_bridge.dart`.
